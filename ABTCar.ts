...
namespace ABT_Car {
    ...
    //% blockId=ABT_LED0 block="LED|cl: %cl|value %value"
    //% weight=5
    //% blockGap=8
    //% color="#228B22"
    //% group="ABT_display"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=1
    export function LED0(cl:ABT_LED1,value: ABT_LED): void {
        if(cl==ABT_LED1.left){
            pins.digitalWritePin(DigitalPin.P1, value);
        } else if (cl == ABT_LED1.right){
            pins.digitalWritePin(DigitalPin.P2, value);
        }else if(cl == ABT_LED1.all){
            pins.digitalWritePin(DigitalPin.P1, value);
            pins.digitalWritePin(DigitalPin.P2, value);
        } else {
    ...
    //% blockId=ABT_LED1 block="LED1|value %value"
    //% weight=4
    //% blockGap=8
    //% color="#228B22"
    ...
    export function LED1(value: number): void {
        pins.analogWritePin(AnalogPin.P1, value * 1024 / 256);
        pins.analogWritePin(AnalogPin.P2, value * 1024 / 256);
    }
    //% blockId=ABT_BreathLED block="BreathLED"
    //% weight=3
    //% blockGap=8
    //% color="#228B22"
    //% group="ABT_display"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=3
    export function BreathLED(): void {
        for (let i: number = 0; i < 1023; i++) {
            pins.analogWritePin(AnalogPin.P1, i);
            pins.analogWritePin(AnalogPin.P2, i);
            //basic.pause(1);
    ...
    export function ABTCar(direction: Controldirection){
        switch(direction){
            ...
            case Controldirection.r_forward: {
                ...
                pins.analogWritePin(L_forward, 1023);
                pins.analogWritePin(R_backward, 0);
                pins.analogWritePin(R_forward, 512);
            }; break;
            ...
            case Controldirection.r_backward: {
                ...
                pins.analogWritePin(R_backward, 512);
                pins.analogWritePin(R_forward, 0);
            }; break;
            ...
            case Controldirection.l_backward: {
                pins.analogWritePin(L_backward, 512);
                pins.analogWritePin(L_forward, 0);
                pins.analogWritePin(R_backward, 1023);
                pins.analogWritePin(R_forward, 0);
            }; break;
            ...
            case Controldirection.l_forward: {
                pins.analogWritePin(L_backward, 0);
                pins.analogWritePin(L_forward, 512);
                pins.analogWritePin(R_backward, 0);
                pins.analogWritePin(R_forward, 1023);
            }; break;
